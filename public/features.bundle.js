var FeaturesBundle = (() => {
  ...
  // features/calendar-core/engine/calendar.js
  var require_calendar = __commonJS({
    "features/calendar-core/engine/calendar.js"(exports, module) {
      var { Solar, Lunar } = require_lunar_javascript();
      var CALENDAR_VERSION = "calendar-core@1.0.0";
      ...
      function normalizeInput(input, options = {}) {
        ...
        if (opts.trueSolarTime && input.longitude != null) {
          ...
          trueSolarOffsetMinutes = Math.round(deltaLongitude * 4);
          const totalMinutes = hour * 60 + minute + trueSolarOffsetMinutes;
          hour = Math.floor(totalMinutes / 60) % 24;
          minute = (totalMinutes % 60 + 60) % 60;
          if (totalMinutes < 0) {
            const d = new Date(Date.UTC(year, month - 1, day) - 864e5);
      ...
      function solarToLunar(year, month, day, hour, minute = 0) {
        ...
        return {
          ...
          // 当前节气名（若无返回空字符串）
          solarTerm: lunar.getJie(),
          // 节令
          currentQi: lunar.getQi(),
          // 中气
  ...
  // features/calendar-core/index.js
  var require_calendar_core = __commonJS({
    "features/calendar-core/index.js"(exports, module) {
      var cal = require_calendar();
      module.exports = cal;
      module.exports.CALENDAR_VERSION = cal.CALENDAR_VERSION;
    }
  });

  // features/bazi/rules/bazi-rules-v1.js
  var require_bazi_rules_v1 = __commonJS({
    "features/bazi/rules/bazi-rules-v1.js"(exports, module) {
      var TIAN_GAN = ["\u7532", "\u4E59", "\u4E19", "\u4E01", "\u620A", "\u5DF1", "\u5E9A", "\u8F9B", "\u58EC", "\u7678"];
      var DI_ZHI = ["\u5B50", "\u4E11", "\u5BC5", "\u536F", "\u8FB0", "\u5DF3", "\u5348", "\u672A", "\u7533", "\u9149", "\u620C", "\u4EA5"];
      var GAN_WUXING = {
        "\u7532": "\u6728",
  ...
  // features/bazi/engine/bazi.js
  var require_bazi = __commonJS({
    "features/bazi/engine/bazi.js"(exports, module) {
      var cal = require_calendar_core();
      var rules = require_bazi_rules_v1();
      var ALGORITHM_VERSION = "bazi@1.0.0";
      var RULESET = rules.RULESET_VERSION;
      function paiPan(input, options = {}) {
        ...
        for (let i = 0; i < 80; i++) {
          ...
          const yearPillar = cal.getFourPillars(y, 6, 15, 12, 0);
  ...
  // features/bazi/index.js
  var require_bazi2 = __commonJS({
    "features/bazi/index.js"(exports, module) {
      var bazi = require_bazi();
      var rules = require_bazi_rules_v1();
      module.exports = bazi;
  ...
  // features/ziwei/rules/ziwei-rules-v1.js
  var require_ziwei_rules_v1 = __commonJS({
    "features/ziwei/rules/ziwei-rules-v1.js"(exports, module) {
      var PALACES = ["\u5B50", "\u4E11", "\u5BC5", "\u536F", "\u8FB0", "\u5DF3", "\u5348", "\u672A", "\u7533", "\u9149", "\u620C", "\u4EA5"];
      var PALACE_ROLES = [
        "\u547D\u5BAB",
        "\u5144\u5F1F\u5BAB",
        "\u592B\u59BB\u5BAB",
      ...
      function getYearlyPalace(birthYear, targetYear) {
        const cal = require_calendar_core();
  ...
  // features/ziwei/engine/ziwei.js
  var require_ziwei = __commonJS({
    "features/ziwei/engine/ziwei.js"(exports, module) {
      var cal = require_calendar_core();
      var rules = require_ziwei_rules_v1();
      var ALGORITHM_VERSION = "ziwei@1.0.0";
      var RULESET = rules.RULESET_VERSION;
      function paiPan(input, options = {}) {
        const norm = cal.normalizeInput(input, options);
        const opts = norm.options;
  ...
  // features/ziwei/index.js
  var require_ziwei2 = __commonJS({
    "features/ziwei/index.js"(exports, module) {
      var ziwei = require_ziwei();
      var rules = require_ziwei_rules_v1();
  ...
  // features/meihua/rules/meihua-rules-v1.js
  var require_meihua_rules_v1 = __commonJS({
    "features/meihua/rules/meihua-rules-v1.js"(exports, module) {
      var XIANTIAN_BAGUA = ["\u4E7E", "\u5151", "\u79BB", "\u9707", "\u5DFD", "\u574E", "\u826E", "\u5764"];
      var XIANTIAN_NUMBER = { "\u4E7E": 1, "\u5151": 2, "\u79BB": 3, "\u9707": 4, "\u5DFD": 5, "\u574E": 6, "\u826E": 7, "\u5764": 8 };
      var BAGUA_WUXING = {
        "\u4E7E": "\u91D1",
        "\u5151": "\u91D1",
        "\u79BB": "\u706B",
  ...
  // features/meihua/engine/meihua.js
  var require_meihua = __commonJS({
    "features/meihua/engine/meihua.js"(exports, module) {
      var cal = require_calendar_core();
      var rules = require_meihua_rules_v1();
      var ALGORITHM_VERSION = "meihua@1.0.0";
      var RULESET = rules.RULESET_VERSION;
      var ZHI_NUMBER = {
        "\u5B50": 1,
        "\u4E11": 2,
  ...
  // features/meihua/index.js
  var require_meihua2 = __commonJS({
    "features/meihua/index.js"(exports, module) {
      var meihua = require_meihua();
      var rules = require_meihua_rules_v1();
  ...
  // features/daliuren/rules/daliuren-rules-v1.js
  var require_daliuren_rules_v1 = __commonJS({
    "features/daliuren/rules/daliuren-rules-v1.js"(exports, module) {
      var TIAN_GAN = ["\u7532", "\u4E59", "\u4E19", "\u4E01", "\u620A", "\u5DF1", "\u5E9A", "\u8F9B", "\u58EC", "\u7678"];
      var DI_ZHI = ["\u5B50", "\u4E11", "\u5BC5", "\u536F", "\u8FB0", "\u5DF3", "\u5348", "\u672A", "\u7533", "\u9149", "\u620C", "\u4EA5"];
      var DI_ZHI_INDEX = {};
      ...
      var TIANJIANG = ["\u8D35\u4EBA", "\u817E\u86C7", "\u6731\u96C0", "\u516D\u5408", "\u52FE\u9648", "\u9752\u9F99", "\u5929\u7A7A", "\u767D\u864E", "\u592A\u5E38", "\u7384\u6B66", "\u592A\u9634", "\u5929\u540E"];
      var GUIREN_TABLE = {
        "\u7532": ["\u4E11", "\u672A"],
        "\u620A": ["\u4E11", "\u672A"],
        "\u5E9A": ["\u4E11", "\u672A"],
      ...
      function lessonRelation(up, down) {
        ...
        if (wu === wd) return "\u6BD4\u548C";
        if (WUXING_KE[wu] === wd) return "\u4E0A\u514B\u4E0B";
        if (WUXING_KE[wd] === wu) return "\u4E0B\u8D3C\u4E0A";
        return "\u65E0\u514B";
      }
      ...
      function calcSanChuan(lessons, tianPan, dayGan, dayZhi, yueJiang, hourZhi) {
        ...
        if (yueJiang === hourZhi) {
          ...
          const trans2 = calcMiddleLast(r.initial, tianPan);
          trace.fuYin = r;
          return { ...trans2, method: r.method, trace };
        }
        if (DI_ZHI_INDEX[yueJiang] === (DI_ZHI_INDEX[hourZhi] + 6) % 12) {
          const zei2 = tryZeiKou(lessons);
          if (zei2.initial) {
            const trans3 = calcMiddleLast(zei2.initial, tianPan);
            trace.zeiKou = zei2;
            return { ...trans3, method: zei2.method, trace };
          }
        ...
        trace.zeiKou = zei;
        if (zei.initial) {
          const trans2 = calcMiddleLast(zei.initial, tianPan);
          return { ...trans2, method: zei.method, trace };
        }
        if (zei.candidates.length >= 2) {
          const bi = tryBiYong(zei.candidates, dayGan);
          trace.biYong = bi;
          if (bi.initial) {
            const trans3 = calcMiddleLast(bi.initial, tianPan);
            return { ...trans3, method: bi.method, trace };
          }
          const she = trySheHai(zei.candidates, tianPan, dayGan);
          trace.sheHai = she;
          const trans2 = calcMiddleLast(she.initial, tianPan);
          return { ...trans2, method: she.method, trace };
        }
        const yao = tryYaoKou(lessons, dayGan);
        trace.yaoKou = yao;
        if (yao.initial) {
          const trans2 = calcMiddleLast(yao.initial, tianPan);
          return { ...trans2, method: yao.method, trace };
        }
        const ganJi = GAN_JI_ZHI[dayGan];
        if (ganJi === dayZhi) {
          const ba = tryBaZhuan(lessons, dayGan);
          trace.baZhuan = ba;
          const trans2 = calcMiddleLast(ba.initial, tianPan);
          return { ...trans2, method: ba.method, trace };
        }
  ...
  // features/daliuren/engine/daliuren.js
  var require_daliuren = __commonJS({
    "features/daliuren/engine/daliuren.js"(exports, module) {
      var cal = require_calendar_core();
      var rules = require_daliuren_rules_v1();
      var ALGORITHM_VERSION = "daliuren@1.0.0";
      var RULESET = "daliuren-ruleset-v1";
      function paiPan(input, options = {}) {
        const norm = cal.normalizeInput(input, options);
        const opts = norm.options;
        const pillars = cal.getFourPillars(
        ...
        const tianPanJiangMap = {};
        for (let i = 0; i < 12; i++) {
          const tianPanZhi = tianPan[i];
          const jiang = tianJiang.positions[i];
  ...
  // features/daliuren/index.js
  var require_daliuren2 = __commonJS({
    "features/daliuren/index.js"(exports, module) {
      var daliuren = require_daliuren();
      var rules = require_daliuren_rules_v1();
  ...
  // features/browser-entry.js
  var require_browser_entry = __commonJS({
    "features/browser-entry.js"(exports, module) {
      var bazi = require_bazi2();
      var ziwei = require_ziwei2();
      var meihua = require_meihua2();
      var daliuren = require_daliuren2();
      var calendar = require_calendar_core();
