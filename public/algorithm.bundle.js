var QiMenAlgorithmBundle = (() => {
  ...
  var require_qimen = __commonJS({
    "algorithm/qimen.js"(exports, module) {
      ...
      var SHEN = ["\u7384\u6B66", "\u767D\u864E", "\u592A\u5E38", "\u516D\u5408", "\u52FE\u9648", "\u817E\u86C7", "\u7384\u7075", "\u5929\u540E", "\u4E5D\u5929", "\u592A\u9634", "\u8D35\u795E", "\u9752\u9F99", "\u6731\u96C0"];
      ...
      var FORWARD_ORDER = [2, 10, 11, 0, 12, 6, 5, 4, 8, 9, 1, 7, 3];
      var REVERSE_ORDER = [12, 11, 0, 10, 3, 2, 7, 1, 8, 9, 4, 6, 5];
      var LUOSHU_POS = {
        4: { x: 0, y: 0 },
        // 巽
        9: { x: 1, y: 0 },
...
====== ${ok1 && ok2 && ok3 && ok4 ? "\u5168\u90E8\u9A8C\u8BC1\u901A\u8FC7 \u2705" : "\u5B58\u5728\u5931\u8D25 \u274C"} ======`);
  ...
  var require_pillars = __commonJS({
    "algorithm/pillars.js"(exports, module) {
      var { Solar } = require_lunar_javascript();
